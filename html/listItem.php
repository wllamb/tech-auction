...
// if everything is ok, we try to upload file...
    ...
    if (move_uploaded_file($_FILES["image"]["tmp_name"], $target_file)) {
        ...
        echo "The file ". basename( $_FILES["image"]["name"]). " has been uploaded.";
			...
			//$sql = "INSERT INTO itemlist (category, title, img, price, length, description, owner, dateposted, bidderid) VALUES ('$category', '$title', '$imgLink', '$startPrice', '$length', '$desc', '$owner', '$date', '$currentbidder');";
